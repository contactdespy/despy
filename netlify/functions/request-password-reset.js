  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden">
      <div style="background:#010410;padding:18px 28px;text-align:center">
        <img src="https://despy.fr/assets/logo-despy-email-dark.png" alt="Despy" width="110" style="color:#fff;font-size:22px;font-weight:900;width:110px;max-width:45%;height:auto;display:inline-block;border:0">
      </div>
